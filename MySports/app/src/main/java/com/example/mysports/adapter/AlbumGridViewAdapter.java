...
import com.example.mysports.util.BitmapCache;
import com.example.mysports.util.BitmapCache.ImageCallback;
import com.example.mysports.util.ImageItem;
import com.example.mysports.util.Res;
...
public class AlbumGridViewAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        com.example.mysports.adapter.AlbumGridViewAdapter.ViewHolder viewHolder;
        if (convertView == null) {
            viewHolder = new com.example.mysports.adapter.AlbumGridViewAdapter.ViewHolder();
...
//			viewHolder.imageView.setLayoutParams(lp);
            ...
            viewHolder = (com.example.mysports.adapter.AlbumGridViewAdapter.ViewHolder) convertView.getTag();
        }
        String path;
...
//					path, Res.getDrawableID("plugin_camera_camera_default"), 100, 100);
        ...
        viewHolder.toggleButton.setOnClickListener(new com.example.mysports.adapter.AlbumGridViewAdapter.ToggleClickListener(viewHolder.choosetoggle));
    ...
    private com.example.mysports.adapter.AlbumGridViewAdapter.OnItemClickListener mOnItemClickListener;

    public void setOnItemClickListener(com.example.mysports.adapter.AlbumGridViewAdapter.OnItemClickListener l) {
